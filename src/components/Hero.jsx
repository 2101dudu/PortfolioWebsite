        ...
        <div class="max-w-screen-xl flex justify-between mx-auto py-40 px-8">
          <div class="max-w-md lg:max-w-xl pt-8">
            <div class="w-full m-0 pb-8">
              <h1 class="text-lato font-bold text-6xl">Front-end <span class="text-transparent bg-clip-text bg-gradient-to-l from-tempdarkblue to-templightblue">Software Engineer</span>👨‍💻</h1>
            </div>
            <h2 class="text-lato font-medium text-4xl pb-8">Based in Braga, student at University of Minho.</h2>
            <ul class="flex">
          ...
          <div class="max-w-sm lg:max-w-md">
            <img class="rounded-full w-full h-auto" src="src/assets/ProfilePhoto.png" alt="Profile Photo"></img>
          </div>
        </div>
