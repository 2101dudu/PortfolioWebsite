...
function Hero() {
    return (
        <div class="bg-tempwhite">
          <div class="bg-tempwhite px-3 min-[320px]:px-8 pt-16 sm:pt-24 visible md:m-0 md:h-0 md:invisible w-full md:p-0">
            <h1 class="text-lato font-bold text-4xl min-[470px]:text-5xl min-[540px]:text-6xl sm:text-7xl tracking-normal text-transparent bg-clip-text bg-gradient-to-bl from-tempdarkblue to-templightblue">Eduardo Faria</h1>
          </div>
          <div class="bg-tempwhite max-w-screen-xl flex flex-col items-center min-[320px]:flex-row justify-between mx-auto space-x-0 min-[320px]:space-x-2 sm:pt-8 md:pb-32 md:py-40 px-3 min-[320px]:px-8 md:px-12">
            <div class="max-w-md lg:max-w-xl pt-8">
              <div class="w-full m-0 pb-8">
                <h1 class="text-lato text-tempblack font-bold text-2xl min-[470px]:text-3xl sm:text-5xl md:text-6xl tracking-normal">Front-end <span class="text-transparent bg-clip-text bg-gradient-to-l from-tempdarkgreen to-templightgreen md:from-tempdarkblue md:to-templightblue">Software Engineer</span>👨‍💻</h1>
              </div>
              <h2 class="text-lato text-tempblack font-medium text-base min-[470px]:text-xl min-[540px]:text-2xl sm:text-3xl md:text-4xl pb-8">Based in Braga, student at the University of Minho.</h2>
