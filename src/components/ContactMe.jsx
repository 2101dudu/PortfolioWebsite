          ...
          <div class="h-100vh w-screen -skew-y-3">
            <div class="flex flex-col space-y-8 pt-28 max-w-screen-xl md:px-12 lg:px-4 mx-auto">
              ...
              <div class="flex pt-10 justify-between space-x-8 lg:space-x-20">
                <div class="flex flex-col space-y-8 md:w-2/5 lg:w-1/3">
                  <div class="h-12 shadow-4xl rounded-lg">
                    <input type="name"  name="floating_name"  id="floating_name"  class="h-full w-full z-10 peer bg-transparent border-0 rounded-lg bg-gradient-to-tr from-transparentwhite focus:ring-4 focus:ring-tempwhite p-2.5 md:text-lg lg:text-xl font-lato text-tempwhite md:placeholder:text-lg lg:placeholder:text-xl placeholder:font-lato placeholder:text-tempwhite" placeholder="Name..."  required></input>
                  </div>
                  <div class="h-12 shadow-4xl rounded-lg">
                ...
                <textarea type="message" rows="4" name="floating_message" id="floating_message" class="md:w-3/5 lg:w-2/3 h-32 shadow-4xl max-h-64 bg-transparent border-0 rounded-lg bg-gradient-to-tr from-transparentwhite focus:ring-4 focus:ring-tempwhite p-2.5 md:text-lg lg:text-xl font-lato text-tempwhite md:placeholder:text-lg lg:placeholder:text-xl placeholder:font-lato placeholder:text-tempwhite" placeholder="Message..." required></textarea>
              </div>
            </div>
          </div>  
          <div class="h-96 w-screen -skew-y-3">
            <div class="max-w-screen-xl md:px-12 lg:px-4 pt-12 mx-auto">
              <a href="" class="md:duration-300 md:hover:scale-105 shadow-4xl rounded-xl w-48 h-20 lg:w-56 lg:h-24 bg-gradient-to-tr block from-tempdarkblue to-templightblue md:mr-32 lg:mr-72">
                <div class="text-lato font-bold text-tempwhite text-3xl lg:text-4xl text-center pt-6 lg:pt-7">Send</div>
              </a>
            </div>
          </div>
        </div>
