function Footer() {
    return(
        <div class="bg-tempblack">
          ...
          <div class="max-w-screen-xl sm:px-8 md:px-12 lg:px-4 mx-auto sm:h-20 md:h-28 flex justify-between sm:pt-3 md:pt-10">
            <div class="flex w-1/2 lg:w-1/3 pt-2.5 justify-between">
              <div class="text-tempwhite sm:text-sm md:text-md font-lato font-normal">eduardo21faria@gmail.com</div>
              <div class="text-tempwhite sm:text-sm md:text-md font-lato font-normal">|</div>
              <div class="text-tempwhite sm:text-sm md:text-md font-lato font-normal">+351 918718340</div>
            </div>
