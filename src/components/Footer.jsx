    ...
    return(
        <div class="bg-tempblack">
          ...
          <div class="max-w-screen-xl px-8 md:px-12 lg:px-4 mx-auto h-20 md:h-28 flex justify-between pt-3 md:pt-10">
            <div class="flex min-[320px]:w-3/5 md:w-1/2 lg:w-1/3 pt-2.5 justify-between">
          ...
          <h2 class="min-[320px]:text-xs sm:text-base text-center font-lato text-tempgray duration-300 hover:text-tempwhite pb-2">© 2023 Eduardo Faria</h2>
        </div>
    );
}
